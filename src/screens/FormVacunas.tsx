...
type FormVacunaProps = NativeStackScreenProps<RootStackPramList, "FormVacuna">

var calificaSelected: string | number = null
var especieSelected: string | number = null

const FormVacunas = ({ navigation, route }: FormVacunaProps) => {
    ...
    const [vacunas, setComment] = useState(
        vacuna
    )
    const especie=()=>(
        <>
        ...
        <>
            <View>
                <Text style={styles.heading}>
                    Nivel de urgencia (rojo: Urgente, Verde:No urgente )
                </Text>
            </View>
            <View
                style={{
                ...
                <View style={styles.formContainer}>
                    ...
                    <Formik
                        ...
                        onSubmit={async (values) => {
                            ...
                            let idCom:string = ''+vacuna.diagnosticos.length
                            
                            vacuna.diagnosticos.push({ id: idCom, name: values.nombre,date:getCurrentDate(),especie:especieSelected, estado: calificaSelected, descripcion: values.comentario })
